...
from .single_label import Accuracy, ConfusionMatrix, SingleLabelMetric,self_Accuracy
...
__all__ = [
    'Accuracy', 'SingleLabelMetric', 'MultiLabelMetric','self_Accuracy','AveragePrecision',
